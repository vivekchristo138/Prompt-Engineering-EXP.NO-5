...
OUTPUT:
<img width="914" height="804" alt="image" src="https://github.com/user-attachments/assets/237f676a-cc83-4e0d-9a01-c4af26fbe7d4" />

RESULT: 

 different pattern models respond to various prompts (broad or unstructured) versus basic prompts (clearer and more refined) across multiple scenarios was cpmpared successfully.
